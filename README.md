...
Since npm deprecated classic tokens, `npm login` tokens now **expire after just 2 hours**. If you use private npm packages, you're forced to re-authenticate multiple times per day and face frequent 404 not found errors when installing dependencies.
